...
export default class NPC extends Character {
    constructor(scene, x, y, textureKey = 'receptionist', options = {}) {
        ...
        this.movementType = options.type || 'static'; 
        this.speed = options.speed || 50;
        this.range = options.range || 128; 
        this.target = options.target || null; 
        this.interactionType = options.interactionType || null;
        this.interactionCallback = options.interactionCallback || null; 
    ...
    startChase() {
        ...
        this.scene.physics.world.on('worldstep', () => {
            ...
            if (distance < 50) {
                this.sprite.setVelocity(velocityX * 0.5, velocityY * 0.5); 
            } else {
                this.sprite.setVelocity(velocityX, velocityY);
            }  
