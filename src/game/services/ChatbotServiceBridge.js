// src/services/ChatbotServiceBridge.js
...
class ChatbotServiceBridge {
    ...
    async sendMessage(message) {
        try {
            ...
            if (result.success) {
                ...
                // En cas d'erreur du service, retourner le message d'erreur
     ...
     */
    getHistory() {
        // Si votre ChatbotService a une méthode pour récupérer l'historique
     ...
     */
    isReady() {
        // Ajoutez ici la logique pour vérifier si votre service est prêt
